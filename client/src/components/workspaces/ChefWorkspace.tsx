    ...
    return (
        <>
            <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                <UtensilsCrossed style={{ width: '0.7rem', height: '0.7rem' }} /> {t('workspace.recipes', { label: secondaryJobLabel })}
            </div>
                        ...
                        >
                            ...
                            >
                                <div style={{ fontSize: '0.85rem', fontWeight: 700, color: 'rgba(255,255,255,0.92)' }}>
                                    {t('workspace.choose_ingredients_cook', { name: selectedRecipe.name })}
                                </div>
