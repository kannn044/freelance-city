                ...
                <div style={{ display: 'grid', gridTemplateColumns: showSecondaryJobColumn ? 'repeat(2, minmax(280px, 1fr))' : '1fr', gap: '0.9rem' }}>
                    <div
                        style={{
                            ...
                            borderRadius: '0.8rem',
                            background: 'linear-gradient(180deg, rgba(10,5,0,0.62), rgba(22,13,5,0.55))',
                    ...
                    {showSecondaryJobColumn && (
                        <div
                            style={{
                                ...
                                borderRadius: '0.8rem',
                                background: 'linear-gradient(180deg, rgba(30,19,10,0.55), rgba(22,13,5,0.5))',
                                height: ORDERS_COLUMN_HEIGHT,
                                minHeight: ORDERS_COLUMN_HEIGHT,
                                overflow: 'hidden',
                            }}
